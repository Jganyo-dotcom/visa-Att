...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        showMessage(
          "loginMessage",
          "Login connection failed! Check your server status.",
          "error",
        );
      }
    });
  ...
  function executeSessionOnboarding(data) {
    ...
    // SAFETY FIX: Prevents infinite redirect loops if this file is loaded globally
  ...
  // Automatic running check on startup
  verifySession();
